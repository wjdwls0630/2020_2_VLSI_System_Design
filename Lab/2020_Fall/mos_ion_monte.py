...
Original file is located at
    https://colab.research.google.com/drive/1W2dgDvYnqXe1uRc4YaaDV0rzrgXCoj7z
"""
...
with open('mos_ion_monte.lis', "r+") as f:
    data = f.readlines()
...
pyplot.title("Process Variation for PMOS and NMOS\n3-Sigma, NP Correlation = 0, MONTE=2500")
pyplot.legend()
pyplot.savefig('mos_ion_monte_cor_0.0.png')
pyplot.show()
